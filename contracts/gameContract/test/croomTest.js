...
var croomAddress = register.get("CroomManagertest");
if(emptyaddress(croomAddress)){
    console.log("请先部署room");
    return;
}
var gameAddress=register.get("gameTokentest");
if(emptyaddress(gameAddress)){
    console.log("请先部署gameTokentest 项目");
    return;
}
...
var game = web3.eth.contract(gameabi).at(register.get("gameTokentest"))
